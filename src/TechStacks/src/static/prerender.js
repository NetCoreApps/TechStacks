...
(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        getPreRender = function (path) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("" + prerenderUrl + (path || "/"))];
        ...
        if (hasData())
            return [2 /*return*/];
        injectPrenderedContent = function () { return __awaiter(_this, void 0, void 0, function () {
            var html, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, getPreRender(path)];
                    case 2:
                        html = _a.sent();
                        if (!html || html.trim().length == 0) {
                            if (log)
                                console.log("empty html, skipping prerendering...");
                            return [2 /*return*/];
                        }
                        if (hasData())
                            return [2 /*return*/];
                    ...
                    case 3:
                        e_1 = _a.sent();
                        if (log)
                            console.log("prerender error", e_1);
                        return [3 /*break*/, 4];
