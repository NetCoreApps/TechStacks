...
public class MarkdownProvider : IMarkdownProvider
{
    ...
    public virtual T CreateMarkdownFile<T>(string content, TextWriter writer, MarkdownPipeline? pipeline = null)
    ...
    public string Transform(string markdown)
    {
        ...
        var doc = CreateMarkdownFile<MarkdownFileInfo>(markdown, writer, pipeline);
    ...
    where T : MarkdownFileBase
{
    ...
    public virtual T? Load(string path, MarkdownPipeline? pipeline = null)
    {
        ...
        doc.Slug = StringExtensions.GenerateSlug(doc.FileName.WithoutExtension());
        doc.Content = content;
...
{
    public List<MarkdownMenu> Headings { get; } = [];
}
